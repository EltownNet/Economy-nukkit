package net.eltown.economy.components.tinyrabbit;

import com.rabbitmq.client.*;
import net.eltown.economy.components.tinyrabbit.data.Delivery;
import net.eltown.economy.components.tinyrabbit.data.Request;
...
public class TinyRabbitListener {
    ...
    public void receive(final Consumer<net.eltown.economy.components.tinyrabbit.data.Delivery> received, final String connectionName, final String queue) {
        try {
