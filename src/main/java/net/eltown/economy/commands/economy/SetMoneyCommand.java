...
public class SetMoneyCommand extends PluginCommand<Economy> {

    public SetMoneyCommand(Economy owner, ConfigSection section) {
            ...
            if (args.length >= 2) {
                ...
                Economy.getAPI().hasAccount(target, (has) -> {
                    try {
                        ...
                        Economy.getAPI().setMoney(finalTarget, amt);
